...
@optional
- (void)didSelectDate:(PickerViewController *)picker date:(NSDate *)date formattedString:(NSString *)dateString; // * For DateAndTimePickerType, DatePickerType
- (void)didSelectItemAtIndex:(PickerViewController *)picker index:(NSUInteger)index; // * For CustomPickerType
@end
